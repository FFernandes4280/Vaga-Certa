...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(autenticar)\_layout` | `/(autenticar)\cadastrar` | `/(autenticar)\entrar` | `/(entrar)\_layout` | `/(entrar)\cadastrar` | `/(entrar)\entrar` | `/(tabs)` | `/_sitemap` | `/cadastrar` | `/entrar`;
